...
session_start(); 
  ...
  $idnew =$_GET['id'];
   //$idnew;   
  //$select= mysql_query("select * from registration where id = '$idnew'");
  ...
  //echo   $currentdate;
   ...
   if(isset($_POST['submit'])){
    ...
    $id = $_POST['userid'];
     $sql=mysqli_query($link,"INSERT INTO te_notice (id, title, date_of_publish, notice, fine, last_date)
      ...
      <div class="col-md-10">
       <p class="welcome"> Welcome &nbsp;&nbsp;  <span style="color:#2484A4;"> <?php echo $_SESSION['username']; ?>  </span></p>
        ...
        <?php $username=$_SESSION['username'];   ?>
           ...
           <form class="form-horizontal" role="form" action="te_mknotice.php" method="POST">
